...
#define ApplicationVersion GetFileVersion(".\exe.win32-3.6\p2b-gui.exe")
...
[Files]
Source: ".\exe.win32-3.6\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs; Excludes: "q*d4.dll,Qt5Web*,Qt5Q*,qtwebengine*,qml"
