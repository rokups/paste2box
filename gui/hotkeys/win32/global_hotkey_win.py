...
class GlobalHotkeyManagerWin(GlobalHotkeyManagerBase):
    ...
    _qt_key_to_vk = {
        Qt.Key_Escape: VK_ESCAPE, Qt.Key_Tab: VK_TAB, Qt.Key_Backtab: VK_TAB, Qt.Key_Backspace: VK_BACK,
        Qt.Key_Return: VK_RETURN, Qt.Key_Enter: VK_RETURN, Qt.Key_Insert: VK_INSERT, Qt.Key_Delete: VK_DELETE,
        Qt.Key_Pause: VK_PAUSE, Qt.Key_Print: VK_SNAPSHOT, Qt.Key_Clear: VK_CLEAR, Qt.Key_Home: VK_HOME,
        Qt.Key_End: VK_END, Qt.Key_Left: VK_LEFT, Qt.Key_Up: VK_UP, Qt.Key_Right: VK_RIGHT, Qt.Key_Down: VK_DOWN,
        Qt.Key_PageUp: VK_PRIOR, Qt.Key_PageDown: VK_NEXT,
        Qt.Key_F1: VK_F1, Qt.Key_F2: VK_F2, Qt.Key_F3: VK_F3, Qt.Key_F4: VK_F4, Qt.Key_F5: VK_F5, Qt.Key_F6: VK_F6,
        Qt.Key_F7: VK_F7, Qt.Key_F8: VK_F8, Qt.Key_F9: VK_F9, Qt.Key_F10: VK_F10, Qt.Key_F11: VK_F11,
        Qt.Key_F12: VK_F12, Qt.Key_F13: VK_F13, Qt.Key_F14: VK_F14, Qt.Key_F15: VK_F15, Qt.Key_F16: VK_F16,
        Qt.Key_F17: VK_F17, Qt.Key_F18: VK_F18, Qt.Key_F19: VK_F19, Qt.Key_F20: VK_F20, Qt.Key_F21: VK_F21,
        Qt.Key_F22: VK_F22, Qt.Key_F23: VK_F23, Qt.Key_F24: VK_F24,
        Qt.Key_Space: VK_SPACE,
        # Qt.Key_Asterisk: VK_MULTIPLY,
        # Qt.Key_Plus: VK_ADD,
        Qt.Key_Comma: VK_SEPARATOR, Qt.Key_Minus: VK_SUBTRACT, Qt.Key_Slash: VK_DIVIDE,
    ...
    _qt_key_letters = [getattr(Qt, 'Key_{}'.format(chr(ord('A') + i))) for i in range(ord('Z') - ord('A'))]

    def __init__(self):
        GlobalHotkeyManagerBase.__init__(self)
        # Believe it or not - hooking TranslateMessage() is more stable than using windows hooks.
        self._translate_message_hook_ref = self._TranslateMessage(self._translate_message_hook)
        self._TranslateMessageReal = self._TranslateMessage(
            hotpatch(ctypes.windll.user32.TranslateMessage, self._translate_message_hook_ref)
        )
    ...
    def _register_shortcut(self, receiver, native_key, native_mods, window_id):
        ...
        res = ctypes.windll.user32.RegisterHotKey(self._unwrap_window_id(window_id), int(native_mods) ^ int(native_key),
    ...
    def _unregister_shortcut(self, native_key, native_mods, window_id):
        res = ctypes.windll.user32.UnregisterHotKey(self._unwrap_window_id(window_id),
